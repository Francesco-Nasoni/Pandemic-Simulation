...
Pandemic::Pandemic(int n, double b, double y, double r, double i) : population(n, Person()), N{n}, B{b}, Y{y}, R{r}
{
    S = N;
...
int Pandemic::getSusceptible() const
{
    return S;
}

int Pandemic::getInfected() const
{
    return I;
}

int Pandemic::getDead() const
{
    return D;
}

int Pandemic::getPeopleN() const
{
    return N;
}
