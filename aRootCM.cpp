...
int main() {
  ...
  TGraph *graph_S = new TGraph("Data/ResultCM.txt", "%lg %lg");
  TGraph *graph_I = new TGraph("Data/ResultCM.txt", "%lg %*s %lg");
  TGraph *graph_D = new TGraph("Data/ResultCM.txt", "%lg %*s %*s %lg");

  TGraph *graph_Sr = new TGraph("Data/ResultCM.txt", "%lg %lg");
  TGraph *graph_Ir = new TGraph("Data/ResultCM.txt", "%lg %*s %lg");
  TGraph *graph_Dr = new TGraph("Data/ResultCM.txt", "%lg %*s %*s %lg");
  ...
  leg2->Draw("same");
  canva2->Print("Data/GraphCutCM.pdf");
}